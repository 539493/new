  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Календарь занятий</h1>
          <p className="text-gray-600">Управляйте своим расписанием и отслеживайте забронированные уроки</p>
        </div>
        ...
        <div className="mt-6 bg-white rounded-xl shadow-lg border border-gray-100 p-6">
          ...
          <div className="flex flex-wrap gap-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-gray-700">Свободные слоты</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-4 h-4 bg-green-500 rounded"></div>
              <span className="text-sm text-gray-700">Забронированные слоты</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-4 h-4 bg-amber-500 rounded"></div>
              <span className="text-sm text-gray-700">Запланированные уроки</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 transform transition-all duration-300 scale-100">
            ...
            <div className="space-y-3">
              <div>
                <span className="text-sm font-medium text-gray-500">Предмет:</span>
              ...
              {selectedEvent.type === 'slot' ? (
                <>
                  <div>
                    ...
                    <p className={`font-medium ${selectedEvent.isBooked ? 'text-green-600' : 'text-blue-600'}`}>
                      {selectedEvent.isBooked ? 'Забронирован' : 'Свободен'}
                    </p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-gray-500">Тип урока:</span>
                    <p className="text-gray-900 capitalize">{selectedEvent.lessonType}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-gray-500">Формат:</span>
                    <p className="text-gray-900 capitalize">{selectedEvent.format}</p>
                  </div>
                  <div>
                  ...
                  {!selectedEvent.isBooked && (
                    <div className="mt-4">
                      <span className="text-sm font-medium text-gray-500">Имя студента для бронирования:</span>
                      <input
                        type="text"
                        value={studentName}
                ...
                <>
                  <div>
                    <span className="text-sm font-medium text-gray-500">Ученик:</span>
      ...
      {isCreateSlotModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 transform transition-all duration-300 scale-100">
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-xl font-bold text-gray-900">Создать новый слот</h3>
              <button
      ...
      {mode === 'assign' && student && selectedSlot && !selectedSlot.isBooked && (
        <button
          ...
          disabled={booking}
          style={{ marginTop: 16, padding: '8px 20px', fontSize: 16 }}
        >
