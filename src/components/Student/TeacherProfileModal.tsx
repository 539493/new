        ...
        <div className="p-6">
          ...
          <div className="bg-white rounded-2xl shadow p-6 mb-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <div className="text-base text-gray-900 mt-1">
                  {profile?.experience ? getExperienceLabel(profile.experience) : 'experienced'}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow p-6 mb-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-bold text-gray-900">Истории</h3>
            ...
            <div className="flex space-x-4">
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center relative mb-2">
              ...
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-purple-400 to-pink-500 flex items-center justify-center mb-2">
                  <UserIcon className="w-8 h-8 text-white" />
                </div>
                <span className="text-xs text-gray-600">{teacher.name?.split(' ')[0]}...</span>
              </div>
            </div>
          </div>
